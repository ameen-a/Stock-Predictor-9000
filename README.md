...
NOTE: This tool simply allows you to 'drag-and-drop' common ML algorithms on to your favourite stocks: it does *not* contain statistically-sound machine learning techniques. 
